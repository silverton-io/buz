...
type SnowplowEvent struct {
	...
	Contexts                 *event.SelfDescribingContexts `json:"contexts"`
	Self_describing_event    *event.SelfDescribingPayload  `json:"self_describing_event"` // Self Describing Event
...
type ShortenedSnowplowEvent struct { //A struct used to quickly parse incoming json props or query params. Leverages Go type conversion to long-form props.
	...
	Contexts                 *event.SelfDescribingContexts `json:"cx"`
	Self_describing_event    *event.SelfDescribingPayload  `json:"ue_px"`              // Self Describing Event
